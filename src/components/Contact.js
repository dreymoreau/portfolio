...
const Contact = () => {
  return (
    <div name='contact' className='bg-gradient-to-b from-gray-800 to-black w-full h-full text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                ...
                className='flex flex-col w-full md:w-1/2'>
                    ...
                    <button 
                    className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Lets connect!</button>
                </form>
            </div>
        </div>
    </div>
